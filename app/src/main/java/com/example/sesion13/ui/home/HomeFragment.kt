...
import com.example.sesion13.databinding.FragmentHomeBinding
import com.example.sesion13.ui.auth.LoginViewModel
...
class HomeFragment : Fragment() {
    ...
    private fun viewPager2SetupWithTabLayout(tabLayout: TabLayout, viewPager2: ViewPager2){
        TabLayoutMediator(tabLayout, viewPager2) { tab, position ->
            ...
            when (position) {
                HomeTabs.NOTAS.index -> {
                    tab.customView = view
                    textViewTitle.text = getString(R.string.notas)
